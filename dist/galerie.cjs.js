...
var Glide = require('@glidejs/glide/dist/glide.modular.esm.js');
var Glide__default = _interopDefault(Glide);
...
class Galerie {
  ...
  initCarousel (galeriewrapper) {
    ...
    this.carousel = new Glide__default(this.galeriewrapper, {
      type: 'carousel',
      startAt: 0,
      perView: 9,
      peek: {
    ...
    this.carousel.mount({ Controls: Glide.Controls, Breakpoints: Glide.Breakpoints, Anchors: Glide.Anchors, Swipe: Glide.Swipe, Images: Glide.Images });
